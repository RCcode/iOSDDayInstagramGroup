...
@interface PopularMediaViewController ()<UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,InstagramToolDelegate>
...
- (void)viewWillAppear:(BOOL)animated
{
    if ([self.mediaArray count]==0) {
        ...
        [[InstagramTool shareInstance] getPopularMedia];
